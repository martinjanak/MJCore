...
//}
//
//public final class MJAuthHttpClient<Endpoint: MJHttpEndpoint>: MJAuthHttpClientAny<Endpoint> {
//
...
//
//        guard let request = MJHttp.createRequest(
//            url: url,
...
//                    return
//            }
//            MJHttp.send(authenticatedRequest, with: self.session) { response in
...
//}
//
//open class MJAuthHttpClientAny<Endpoint: MJHttpEndpoint>: MJAuthHttpClientProtocol {
